...
\begin{document}
	...
	\chapter{Trial of number theory}
		...
		\section{Discrete Fourier transform}
			\lstinputlisting[firstline=75,lastline=120]{../src/number.cpp}
		\section{Fast Fourier transform for integer}
			\lstinputlisting[firstline=369,lastline=430]{../src/number.cpp}
		\section{Number-theoretic transform}
			\lstinputlisting[firstline=122,lastline=189]{../src/number.cpp}
		\section{Chinese remainder theorem}
			\lstinputlisting[firstline=191,lastline=224]{../src/number.cpp}
		\section{Linear Recurrence}
			\lstinputlisting[firstline=432,lastline=495]{../src/number.cpp}
		\section{Baby step giant step algorithm}
			\lstinputlisting[firstline=340,lastline=367]{../src/number.cpp}
		\section{Miller Rabin primality test}
			\lstinputlisting[firstline=226,lastline=254]{../src/number.cpp}
		\section{Pollard's Rho algorithm}
			\lstinputlisting[firstline=256,lastline=314]{../src/number.cpp}
		\section{Adaptive Simpson's method}
			\lstinputlisting[firstline=315,lastline=338]{../src/number.cpp}
